...
Route::get('/category',['App\Http\Controllers\HomeController','category'])->name('category')->middleware('can:crud-category');
Route::get('/category/create',['App\Http\Controllers\CategoryController','create'])->name('createcategory')->middleware('can:crud-category');
...
Route::get('/post/delete/{post}',['App\Http\Controllers\PostController','delete']);

Route::post('/posts',['App\Http\Controllers\PostController','store']);
Route::post('category',['App\Http\Controllers\CategoryController','store'])->middleware('can:crud-category');
